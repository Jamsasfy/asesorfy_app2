        ...
        return $schema
            ->components([
                ...
                Grid::make(3)->schema([
                    ...
                    Section::make(fn (Proyecto $record): string => 'Proyecto para ' . ($record->cliente->razon_social ?? 'Cliente Desconocido'))
                        ->schema([
                    ...
                    Section::make('Estado & Asignación')
                        ->schema([
                            ...
                            TextEntry::make('estado')
                                ...
                                ->badge()
                                ->columnSpan(2)
                                ->color(fn (ProyectoEstadoEnum $state) => match ($state->value) {
                                    'pendiente' => 'primary',
                                    'en_progreso' => 'warning',
                                    'finalizado' => 'success',
                                    'cancelado' => 'danger',
                                ...
                                ->suffixAction(
                                    Action::make('cambiar_estado_proyecto')
                                        ...
                                        ->action(function (array $data, Proyecto $record) {
                                            $nuevoEstado = ProyectoEstadoEnum::tryFrom($data['estado']);
                                ...
                                ->suffixAction(
                                    Action::make('reagendar')
                                        ...
                                        ->action(function (array $data, $record) {
                                            ...
                                            $record->save();
                                            $record->comentarios()->create(['user_id' => auth()->id(), 'contenido' => '📅 Nueva agenda: ' . Carbon::parse($data['agenda'])->format('d/m/Y H:i')]);
                                        ...
                                        ->suffixAction(
                                            Action::make('add_llamada')
                                                ...
                                                ->schema([
                                                    ...
                                                    Textarea::make('comentario')->visible(fn(Get $get)=>$get('respuesta'))->required(fn(Get $get)=>$get('respuesta')),
                                                    Toggle::make('agendar')->label('Agendar seguimiento')->live(),
                                                    DateTimePicker::make('agenda')->visible(fn(Get $get)=>$get('agendar'))->minDate(now())
                                                ])
                                                ->action(function(array $data, Proyecto $record){
                                                    self::registrarInteraccion($record, 'llamadas', $data['comentario']??'', $data['respuesta']??false, $data['agendar']??false, isset($data['agenda'])?Carbon::parse($data['agenda']):null);
                                                })
                                        ),
                                    ...
                                    TextEntry::make('emails')
                                        ...
                                        ->suffixAction(
                                            Action::make('add_email')
                                                ...
                                                ->action(function(array $data, Proyecto $record){
                                                    self::registrarInteraccion($record, 'emails', $data['comentario']??'', true, $data['agendar']??false, isset($data['agenda'])?Carbon::parse($data['agenda']):null);
                                                })
                                        ),
                                    ...
                                    TextEntry::make('chats')
                                        ...
                                        ->suffixAction(
                                            Action::make('add_chat')
                                                ...
                                                ->action(function(array $data, Proyecto $record){
                                                    self::registrarInteraccion($record, 'chats', $data['comentario']??'', true, $data['agendar']??false, isset($data['agenda'])?Carbon::parse($data['agenda']):null);
                                                })
                                        ),
                                    ...
                                    TextEntry::make('otros_acciones')
                                        ...
                                        ->suffixAction(
                                            Action::make('add_otro')
                                                ...
                                                ->action(function(array $data, Proyecto $record){
                                                    self::registrarInteraccion($record, 'otros_acciones', $data['comentario']??'', true, $data['agendar']??false, isset($data['agenda'])?Carbon::parse($data['agenda']):null);
                                                })
                                        ),
                ...
                Section::make('🗨️ Comentarios')
                    ->headerActions([
                        Action::make('anadir_comentario')
                            ...
                            ->schema([Textarea::make('contenido')->required()])
                            ->action(function (array $data, Proyecto $record) {
