...
class PlantillasEmailComisionesSeeder extends Seeder
{
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f3f4f6;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f3f4f6; padding: 40px 20px;">
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    <tr>
                        <td style="background: linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%); padding: 30px 40px; text-align: center;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: bold;">Informe de Comisiones</h1>
                            <p style="margin: 10px 0 0 0; color: #e0f2fe; font-size: 16px;">{periodo}</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 30px 40px 20px 40px;">
                            <p style="margin: 0; font-size: 16px; color: #1f2937;">Hola <strong>{comercial_nombre}</strong>,</p>
                        </td>
                    </tr>';
                    ...
                    <tr>
                        <td style="padding: 0 40px;">
                            <div style="background: #f0fdf4; border-left: 4px solid #22c55e; padding: 20px; border-radius: 6px; margin-bottom: 20px;">
                                <p style="margin: 0 0 10px 0; font-size: 18px; font-weight: bold; color: #166534;">¡Enhorabuena!</p>
                    ...
                    <tr>
                        <td style="padding: 0 40px 20px 40px;">
                            <table width="100%" cellpadding="15" cellspacing="0" style="background: #f9fafb; border-radius: 6px;">
                                <tr>
                                    <td style="font-size: 14px; color: #6b7280;"><strong>Total de comisiones generadas:</strong></td>
                                    <td align="right" style="font-size: 20px; font-weight: bold; color: #16a34a;">€{total_comisiones}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 40px;">
                            <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 20px; border-radius: 6px; margin-bottom: 20px;">
                                <p style="margin: 0 0 10px 0; font-size: 18px; font-weight: bold; color: #92400e;">Objetivos no alcanzados</p>
        ...
        PlantillaEmailComision::updateOrCreate(
            ['codigo' => 'comision_supera'],
            [
                'nombre'                 => 'Comisiones - Objetivos Superados',
                'asunto'                 => 'Enhorabuena - Informe de Comisiones - {periodo}',
                'contenido_html'         => $htmlSupera,
        ...
        PlantillaEmailComision::updateOrCreate(
            ['codigo' => 'comision_no_supera'],
            [
                'nombre'                 => 'Comisiones - Objetivos No Alcanzados',
                'asunto'                 => 'Informe de Comisiones - {periodo}',
                'contenido_html'         => $htmlNoSupera,
                'variables_disponibles'  => $variables,
                'activa'                 => true,
            ]
        );
